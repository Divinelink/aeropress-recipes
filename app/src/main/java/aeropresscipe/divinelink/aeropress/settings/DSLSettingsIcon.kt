...
sealed class DSLSettingsIcon {
  ...
  private data class FromResource(
    ...
    override fun resolve(context: Context) =
      requireNotNull(ContextCompat.getDrawable(context, iconId)).apply {
        if (iconTintId != NO_TINT) {
          colorFilter = PorterDuffColorFilter(
            ContextCompat.getColor(context, iconTintId),
  ...
  private data class FromResourceWithBackground(
    ...
    override fun resolve(context: Context): Drawable = LayerDrawable(
      arrayOf(
        ...
        InsetDrawable(
          FromResource(iconId, iconTintId).resolve(context),
          insetPx,
          insetPx,
          insetPx,
          insetPx,
  ...
  private data class FromDrawable(private val drawable: Drawable) : DSLSettingsIcon() {
  ...
  companion object {
    ...
    fun from(
      ...
      FromResourceWithBackground(iconId, iconTintId, backgroundId, backgroundTint, insetPx)

    @JvmStatic
    fun from(
      @DrawableRes iconId: Int,
      @ColorRes iconTintId: Int = R.color.icon_tint_primary,
    ): DSLSettingsIcon = FromResource(iconId, iconTintId)
