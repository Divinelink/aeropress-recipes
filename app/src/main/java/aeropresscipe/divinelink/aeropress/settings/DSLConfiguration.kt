...
import aeropresscipe.divinelink.aeropress.settings.models.Text
import aeropresscipe.divinelink.aeropress.util.mapping.MappingModel
import aeropresscipe.divinelink.aeropress.util.mapping.MappingModelList
  ...
  override fun areItemsTheSame(newItem: Any): Boolean {
    ...
    return when {
      ...
      summary != null -> summary == newItem.summary
        ...
        "Could not determine equality of $newItem. Did you forget to override this method?",
      )
    }
  }
...
class SectionHeaderPreference(override val title: DSLSettingsText) :
