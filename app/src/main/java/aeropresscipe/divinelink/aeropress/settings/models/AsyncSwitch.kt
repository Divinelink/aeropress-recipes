    ...
    adapter.registerFactory(
      LayoutFactory(
        { i: LayoutInflater, r: ViewGroup ->
          ViewHolder(
            DslAsyncSwitchPreferenceItemBinding.inflate(
              i,
              r,
              false,
            ),
  ...
  class Model(
    ...
    override fun areContentsTheSame(newItem: Any): Boolean {
      ...
      return super.areContentsTheSame(newItem) &&
        ...
        isProcessing == newItem.isProcessing
    }
  }

  class ViewHolder(binding: DslAsyncSwitchPreferenceItemBinding) :
    PreferenceViewHolder<Model>(binding) {
