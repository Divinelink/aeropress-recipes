...
class ContextMenuAdapter(private val onItemClick: () -> Unit) :
  ...
  override fun onCreateViewHolder(
    ...
    val itemBinding =
      ContextMenuItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
  ...
  private class ItemViewHolder(
    ...
    fun bind(model: ContextMenuList.DisplayItem) {
      ...
      when (model.displayType) {
        ContextMenuList.DisplayType.TOP -> binding.root.setBackgroundResource(
          R.drawable.context_menu_item_background_top,
        )
        ContextMenuList.DisplayType.BOTTOM -> binding.root.setBackgroundResource(
          R.drawable.context_menu_item_background_bottom,
        )
        ContextMenuList.DisplayType.MIDDLE -> binding.root.setBackgroundResource(
          R.drawable.context_menu_item_background_middle,
        )
        ContextMenuList.DisplayType.ONLY -> binding.root.setBackgroundResource(
          R.drawable.context_menu_item_background_only,
        )
      }
    }
  }
...
//    }
  ...
  private fun List<ActionItem>.toAdapterItems(): List<DisplayItem> = this.mapIndexed {
      index,
      item,
    ->
