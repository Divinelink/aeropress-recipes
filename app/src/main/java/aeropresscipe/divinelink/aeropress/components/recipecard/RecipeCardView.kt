...
class RecipeCardView : CardView {
  var binding: ViewRecipeCardBinding =
    ViewRecipeCardBinding.inflate(LayoutInflater.from(context), this, false)
  ...
  fun setRecipe(card: RecipeCard) {
    ...
    binding.recipeTitle.text =
      context.resources.getString(R.string.dateBrewedTextView, card.brewDate)
    ...
    binding.beansWeightTV.text =
      context.resources.getString(R.string.SavedCoffeeWeightTextView, card.recipe.coffeeAmount)
    binding.beansGrindLevelTV.text =
      context.resources.getString(R.string.SavedGrindLevelTextView, grindSize)
    binding.brewingMethodTextView.text = context.resources.getString(
      R.string.SavedBrewingMethodTextView,
      card.recipe.brewMethod.method,
    )
