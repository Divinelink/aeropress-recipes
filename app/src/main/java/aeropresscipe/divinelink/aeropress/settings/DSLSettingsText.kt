...
sealed class DSLSettingsText {
  ...
  companion object {
    ...
    ): DSLSettingsText = FromResource(stringId, listOf(ColorModifier(textColor)))

    fun from(
      @StringRes stringId: Int,
      vararg modifiers: Modifier,
    ): DSLSettingsText = FromResource(stringId, modifiers.toList())

    fun from(
      charSequence: CharSequence,
      vararg modifiers: Modifier,
    ): DSLSettingsText = FromCharSequence(charSequence, modifiers.toList())
  }
  ...
  class ColorModifier(@ColorInt private val textColor: Int) : Modifier {
    override fun modify(
      context: Context,
      charSequence: CharSequence,
    ): CharSequence = charSequence.color(textColor)
  ...
  object CenterModifier : Modifier {
    override fun modify(
      context: Context,
      charSequence: CharSequence,
    ): CharSequence = charSequence.center()
  }
  ...
  open class TextAppearanceModifier(@StyleRes private val textAppearance: Int) : Modifier {
    override fun modify(
      context: Context,
      charSequence: CharSequence,
    ): CharSequence = charSequence.textAppearance(context, textAppearance)

    override fun equals(other: Any?): Boolean =
      textAppearance == (other as? TextAppearanceModifier)?.textAppearance
  ...
  class LearnMoreModifier(
    ...
    override fun modify(
      context: Context,
      charSequence: CharSequence,
    ): CharSequence = SpannableStringBuilder(charSequence).append(" ").append(
